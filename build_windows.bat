@echo off
REM One-click build of Planloom.exe + planloom-cli.exe (run this ON WINDOWS)
...
echo   dist\Planloom.exe        (double-click GUI)
echo   dist\planloom-cli.exe    (command line)
